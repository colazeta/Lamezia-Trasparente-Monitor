...
| `/stato-monitoraggio` | Added source-health structure for checks, freshness, coverage, caution and priority. | Keep health payload updated as ingestion grows. | Public as technical status, not substantive judgment. | Add check history and error reasons. |
