...
import { classifyAlboPublicAreaTheme } from "./albo-area-theme";
import type { PublicationAreaThemeAssignment } from "./area-theme";

export type AlboPublicationPresentation = PublicationPresentation & {
  area_theme: PublicationAreaThemeAssignment;
};
...
): AlboPublicationPresentation | null {
