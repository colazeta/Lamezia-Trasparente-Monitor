...
const contracts: {
  ...
  },
  {
    ...
    themeSlug: "dissesto-idrogeologico",
  },
  {
    title: "Fornitura arredi asili nido comunali",
    description: "Fornitura di arredi e materiale didattico per i nidi",
    supplier: "Didattica & Co. S.r.l.",
    amount: "96000.00",
    procedureType: "Affidamento diretto",
    status: "Concluso",
    awardDate: "2024-09-15",
    themeSlug: "asili-nido",
  },
  {
  ...
  {
    title: "Progettazione esecutiva piazza centrale",
    description: "Incarico di progettazione per la riqualificazione della piazza",
    supplier: "Studio Associato Architettura LT",
    amount: "78500.00",
    procedureType: "Affidamento diretto",
    status: "Aggiudicato",
...
const acts: {
  ...
  {
    title: "Determina aggiudicazione lavori lungomare",
    type: "Determinazione",
    number: "D-142/2025",
    summary:
      "Aggiudicazione definitiva dei lavori di riqualificazione del lungomare di Marinella",
    publishDate: "2025-02-12",
    endDate: "2025-02-27",
    themeSlug: "lungomare-marinella",
  },
  {
    title: "Avviso pubblico contributi sociali",
    type: "Avviso",
    number: "A-031/2025",
    summary:
      "Avviso per l'erogazione di contributi a sostegno delle famiglie in difficoltà",
    publishDate: "2025-03-10",
    endDate: "2025-04-10",
    themeSlug: "asili-nido",
  },
  {
    title: "Delibera di Giunta bilancio di previsione",
    type: "Deliberazione",
    number: "G-018/2025",
    summary: "Approvazione dello schema di bilancio di previsione 2025-2027",
    publishDate: "2025-01-31",
    endDate: "2025-02-15",
    themeSlug: "bilancio-2025",
  },
  {
    title: "Ordinanza chiusura strada per lavori",
    type: "Ordinanza",
    number: "O-077/2025",
    summary:
      "Chiusura temporanea di Via del Mare per lavori di pavimentazione",
    publishDate: "2025-03-15",
    endDate: "2025-03-22",
    themeSlug: "lungomare-marinella",
  },
  {
    title: "Bando affidamento servizio mensa scolastica",
    type: "Bando",
    number: "B-009/2025",
    summary:
      "Procedura aperta per l'affidamento del servizio di mensa scolastica",
    publishDate: "2025-02-28",
    endDate: "2025-03-28",
    themeSlug: null,
  },
  {
    title: "Avviso manifestazione interesse verde pubblico",
    type: "Avviso",
    number: "A-045/2025",
    summary: "Manifestazione di interesse per la manutenzione delle aree verdi",
    publishDate: "2025-03-01",
    endDate: "2025-03-16",
    themeSlug: "villa-comunale",
  },
  {
    title: "Determina elenco affidamenti diretti",
    type: "Determinazione",
    number: "D-203/2025",
    summary:
      "Pubblicazione elenco affidamenti diretti relativi al II semestre 2024",
    publishDate: "2025-01-10",
    endDate: "2025-01-25",
    themeSlug: "affidamenti-diretti",
  },
  {
    title: "Ordinanza emergenza idrogeologica torrenti",
    type: "Ordinanza",
    number: "O-088/2025",
    summary: "Misure urgenti per la prevenzione del rischio idrogeologico",
  ...
  await db.transaction(async (tx) => {
    ...
    await tx.insert(contractsTable).values(
      contracts.map((c) => ({
        ...
        themeId: c.themeSlug ? themeIdBySlug.get(c.themeSlug)! : null,
      })),
    );

    await tx.insert(actsTable).values(
      acts.map((a) => ({
        title: a.title,
        type: a.type,
        number: a.number,
        ...
        themeId: a.themeSlug ? themeIdBySlug.get(a.themeSlug)! : null,
      })),
    );
