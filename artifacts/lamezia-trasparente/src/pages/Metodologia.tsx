      ...
      <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
        <V0SectionLanding
          ...
          findItems={[
            ...
            "Distinzione tra dati ufficiali, estratti, arricchiti e interpretativi.",
            "Regole per leggere indicatori come segnali da verificare.",
          ]}
          missingItems={[
            "Esempi reali più granulari quando le fonti saranno più mature.",
            "Aggiornamento continuo del changelog metodologico.",
            "Revisione periodica dei criteri insieme alle sezioni data-driven.",
          ]}
          sourceLimit="Il metodo non sostituisce verifiche amministrative, giornalistiche, giuridiche o contabili. Serve a mantenere tracciabilità e prudenza nella consultazione."
          cta={{ label: "Leggi il metodo", href: "#contenuto-principale" }}
          secondaryLink={{ label: "Sezione collegata", href: "/note-legali" }}
        />

        <section
          id="contenuto-principale"
          aria-labelledby="avvio-monitoraggio"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                ...
                pubbliche disponibili. La frequenza effettiva dipende sia dai
                job automatici del sito sia dalla pubblicazione dei dati da
                parte degli enti titolari.
              </p>
            </div>
          </div>
        </section>
        ...
        <section
          aria-labelledby="stati-informativi"
          className="mb-8 rounded-2xl border border-border bg-muted/30 p-6"
        >
          <h2
            id="stati-informativi"
        ...
        <section
          aria-labelledby="fonti-secondarie"
          className="mb-8 rounded-2xl border border-amber-500/30 bg-amber-500/5 p-6 shadow-sm"
        >
          <div className="flex gap-3">
            <ShieldAlert
        ...
        >
          ...
          <div className="mt-4 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              ...
              affidamenti, ricorrenza di fornitori, rotazione debole,
              scostamenti temporali, assenza di allegati, documentazione
              mancante o necessità di ulteriore verifica.
            </p>
            <p>
              ...
              consultare le fonti ufficiali, verificare il contesto
              amministrativo e, se necessario, chiedere chiarimenti con
              strumenti formali come l'accesso civico.
            </p>
          </div>
        </section>

        <section
          aria-labelledby="promessometro-metodo"
          className="mb-8 rounded-2xl border border-border bg-card p-6 shadow-sm"
        >
          <h2
            id="promessometro-metodo"
            className="text-2xl font-display font-bold"
          >
          ...
          <div className="mt-4 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              Il Promessometro collega promesse o linee programmatiche a
              evidenze amministrative disponibili. Ogni record reale deve avere
              fonte programmatica, data, mandato di riferimento, sintesi
              redazionale, cautela interpretativa e ultima verifica. I record
              modello sono esclusi dai conteggi e servono solo a mostrare lo
              schema minimo.
            </p>
            <p>
              La classificazione separa promessa dichiarata, atto di indirizzo,
              atto attuativo/gestionale e realizzazione osservabile. Una
              delibera, un comunicato o una scheda di finanziamento non vengono
              trattati automaticamente come completamento della promessa:
              indicano solo il livello documentale che la fonte consente di
              osservare.
            </p>
            <p>
              Gli stati sono descrittivi e non costituiscono giudizi politici,
              accuse o prove di irregolarità. Assenza di atti collegati, atti
              solo di indirizzo o avanzamento non verificabile sono bisogni di
              verifica documentale da approfondire sulle fonti ufficiali.
            </p>
          </div>
        </section>

        <section
          aria-labelledby="registro-metodologico"
          className="mb-8 rounded-2xl border border-border bg-card p-6 shadow-sm"
        >
          <div className="flex items-start gap-3">
            <History
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                ...
                valutazioni sull'operato di enti, persone o soggetti citati
                negli atti pubblici.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-border bg-muted/30 p-4">
              ...
              <dl className="mt-3 space-y-3">
                {Object.entries(METHODOLOGY_CHANGE_CATEGORIES).map(
                  ([key, category]) => (
                    <div key={key}>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
                    ...
                    <p>
                      <span className="font-semibold text-foreground">
                        Confine con manutenzione ordinaria:
                      </span>{" "}
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed">
                Usa i dati come punto di partenza per verifica civica e
                confronto documentale. Le visualizzazioni pubbliche possono
                evidenziare red flag amministrative, ma non formulano accuse e
                non accertano condotte illecite.
              </p>
        ...
        <div className="mt-8 flex items-start gap-3 rounded-xl border border-border bg-muted/40 px-5 py-4">
          ...
          <p className="text-sm text-muted-foreground">
            rendiamoLameziaTrasparente è un progetto civico indipendente gestito
            da cittadini. Non è un sito istituzionale e non ha alcun legame con
            il Comune di Lamezia Terme. Tutti i dati sono raccolti da fonti
            pubbliche o dichiarati come estratti, arricchiti o da verificare.
          </p>
        </div>
      </div>
    </>
