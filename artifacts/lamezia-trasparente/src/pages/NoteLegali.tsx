  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
        <V0SectionLanding
          eyebrow="Cautele interpretative"
          icon={Scale}
          ...
          findItems={[
            ...
            "Cautele su indicatori, completezza, arricchimenti e riuso pubblico.",
            "Rimandi a fonti istituzionali, metodologia e accesso civico.",
          ]}
          missingItems={[
            "Revisione legale umana prima di pubblicazioni più ampie o dati sensibili.",
            "Aggiornamento dei riferimenti se cambiano norme o fonti istituzionali.",
            "Ulteriori esempi di riuso corretto quando il portale crescerà.",
          ]}
          sourceLimit="Il sito facilita la consultazione ma non produce certificazioni ufficiali, valutazioni definitive su persone, uffici o condotte, né prove di illeciti."
          cta={{
            label: "Leggi le cautele d’uso",
            href: "#contenuto-principale",
          }}
          secondaryLink={{ label: "Sezione collegata", href: "/fonti-dati" }}
        />

        <section
          id="contenuto-principale"
          aria-labelledby="natura-progetto"
        ...
        >
          ...
          <p className="mt-3 leading-relaxed text-muted-foreground">
            rendiamoLameziaTrasparente è un'iniziativa civica indipendente. Non
            è un sito istituzionale, non rappresenta il Comune di Lamezia Terme
            e non produce certificazioni ufficiali. I contenuti servono a
            facilitare la consultazione pubblica, la partecipazione e il
            controllo democratico sull'amministrazione, nel rispetto delle fonti
            e del contesto.
          </p>
        ...
        >
          ...
          <div className="mt-4 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              I dati ufficiali provengono da enti pubblici o piattaforme
              istituzionali. I dati estratti sono campi ricavati da documenti o
              feed ufficiali. I dati arricchiti aggiungono normalizzazioni,
              categorie, geocodifiche o collegamenti per migliorare la
              consultazione. Gli indicatori interpretativi sono sintesi
              costruite dal progetto per evidenziare possibili aree di
              attenzione amministrativa.
            </p>
            <p>
              Un indicatore interpretativo non accerta condotte illecite e non
              può essere usato come prova di illegalità, corruzione,
              favoritismo, collusione o infiltrazione criminale. Può soltanto
              suggerire che un tema richiede ulteriore verifica, confronto con
              la fonte ufficiale e, quando opportuno, richiesta di chiarimenti
              tramite strumenti civici come l'accesso civico.
            </p>
          </div>
        </section>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed">
                ...
                verificare, e conserva sempre il contesto del documento
                originale.
              </p>
              <p className="mt-3 text-sm">
                ...
                . Per segnalazioni formali o richieste documentali usa gli
                strumenti ufficiali dell'ente o la sezione{" "}
                <Link
                  href="/accesso-civico"
                  className="font-semibold underline underline-offset-4"
                >
        ...
        <section
          aria-labelledby="fonti-istituzionali"
          className="mt-8 rounded-2xl border border-border bg-card p-6 shadow-sm"
        >
          <h2
            id="fonti-istituzionali"
            className="text-2xl font-display font-bold"
          >
            Riferimenti istituzionali
          </h2>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Per il quadro normativo e gli obblighi di pubblicazione consulta
            sempre i siti istituzionali competenti. Il sito facilita la
            navigazione, ma le fonti ufficiali restano quelle pubblicate dagli
            enti titolari.
          </p>
