...
export function NoteLegali() {
  usePageMetadata({
    title: "Note legali — rendiamoLameziaTrasparente",
    description:
      "Cautele interpretative, limiti e uso responsabile degli indicatori pubblici del monitoraggio civico di Lamezia Terme.",
  });
