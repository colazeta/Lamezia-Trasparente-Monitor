...
export function Guida() {
  ...
  const chapters = (guideContents?.storyChapters ?? [])
    .slice()
  ...
  return (
    <>
      <PageMeta
        title="Centro guida"
        description="Guida civica per orientarsi nel progetto, riaprire l’introduzione e raggiungere le sezioni pubbliche del sito."
        path="/guida"
      />
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
        <div className="mb-10">
          ...
          <p className="mt-3 text-lg text-muted-foreground max-w-2xl">
            ...
            Riapri l'introduzione o chatta con l'assistente in qualsiasi
            momento.
          </p>
        </div>
            ...
            {sections.length > 0 && (
              <section>
                ...
                <p className="text-muted-foreground mb-6">
                  Un indice di tutte le funzionalità disponibili su
        ...
        <div className="mt-14 rounded-xl border border-primary/20 bg-primary/5 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              L'assistente civico risponde alle tue domande in italiano con dati
              reali.
            </p>
          </div>
          <Button
