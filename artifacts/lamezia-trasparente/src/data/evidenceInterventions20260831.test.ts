...
describe("evidence interventions 2026-08-31", () => {
  it("contains only publishable, sourced and taxonomically valid records", () => {
    expect(EVIDENCE_INTERVENTIONS_2026_08_31).toHaveLength(3);
    for (const item of EVIDENCE_INTERVENTIONS_2026_08_31) {
      ...
      expect(item.lastVerifiedAt).toBe("2026-08-31");
