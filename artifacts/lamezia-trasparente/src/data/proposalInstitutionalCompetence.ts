...
const REGION_CALABRIA_TRANSPORT: ProposalCompetentAuthority = {
  ...
  label: "Regione Calabria",
  level: "regional",
  sourceLabel: "Regione Calabria — Piano Regionale dei Trasporti, Executive summary 2026",
  sourceUrl:
...
> = {
  ...
  "politiche-sociali-progetto-vita-2026": {
    ...
    involvedAuthorities: [ASP_CATANZARO_PROJECT_OF_LIFE, CONFERENZA_SINDACI_ATS_LAMEZIA],
    note:
