...
import { applyScoutingUpdates20260917 } from "./proposalScoutingUpdates20260917";
...
import { SCOUTED_PUBLIC_PROPOSALS_20260917 } from "./propostePubblicheScouting20260917";
...
} from "./proposalCanonicalPresentationArchive20260917";
...
} from "./proposalInstitutionalCompetence20260917";
export {
...
const UPDATED_EXISTING_PUBLIC_PROPOSALS_20260906 =
  UPDATED_EXISTING_PUBLIC_PROPOSALS_20260905.map(applyScoutingUpdates20260906);
const UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260904_20260906 =
  UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260904.map(applyScoutingUpdates20260906);
...
const UPDATED_EXISTING_PUBLIC_PROPOSALS_20260909 =
  UPDATED_EXISTING_PUBLIC_PROPOSALS_20260907.map(applyScoutingUpdates20260909);
const UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260904_20260909 =
  UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260904_20260907.map(
    applyScoutingUpdates20260909,
  );
const UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260906_20260909 =
  UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260906_20260907.map(
    applyScoutingUpdates20260909,
  );
...
const UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260906_20260917 =
  UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260906_20260909.map(
    applyScoutingUpdates20260917,
  );
...
export const PUBLIC_PROPOSALS = [
  ...
  ...UPDATED_SCOUTED_PUBLIC_PROPOSALS_20260906_20260917,
  ...
  ...SCOUTED_PUBLIC_PROPOSALS_20260917,
] as const satisfies readonly core.PublicProposal[];
