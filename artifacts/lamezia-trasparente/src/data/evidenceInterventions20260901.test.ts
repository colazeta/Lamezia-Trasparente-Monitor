...
describe("evidence interventions 2026-09-01", () => {
  it("contains only publishable, sourced and taxonomically valid records", () => {
    expect(EVIDENCE_INTERVENTIONS_2026_09_01).toHaveLength(4);
    for (const item of EVIDENCE_INTERVENTIONS_2026_09_01) {
      ...
      expect(item.lastVerifiedAt).toBe("2026-09-01");
