...
export const EVIDENCE_INTERVENTIONS_2026_09_14_SUPPLEMENT = [
  {
    ...
    tools: ["bolletta mensile", "messaggi randomizzati", "dati di contatore", "segmentazione per consumo", "monitoraggio longitudinale"],
