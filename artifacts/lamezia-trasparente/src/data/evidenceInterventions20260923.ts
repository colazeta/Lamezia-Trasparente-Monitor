...
export const EVIDENCE_INTERVENTIONS_2026_09_23 = [
  ...
  },
  {
    ...
    lastVerifiedAt: "2026-09-23",
    transferabilityItaly:
      "Bassa-media e fortemente condizionata dal diritto. Il principio di documentazione verificabile di alcuni incontri può essere rilevante per una Polizia Locale, ma prima di qualsiasi pilot servono base giuridica, valutazione d'impatto sulla protezione dei dati, regole su attivazione e conservazione, confronto con DPO e rappresentanze del personale, delimitazione delle finalità e verifica delle competenze. Non è un intervento da introdurre come semplice acquisto tecnologico.",
    lameziaAdaptation:
