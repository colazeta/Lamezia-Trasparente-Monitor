...
When invoked from an issue, Codex should produce a dedicated branch and pull request. It should not close the issue directly. The issue may be closed only after review confirms that the acceptance criteria are met and no follow-up issue is required.
